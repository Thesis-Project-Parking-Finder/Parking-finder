...
export default function CantBookings() {
    ...
    <View style={styles.Group219}>
      <View style={styles.Group218}>
        ...
        <View style={styles.Frame217}>
          <Text style={styles.Txt482}>Sorry!</Text>
          <Text style={styles.Txt939}>You Parki Points Insufficient!</Text>
        ...
        >
          <Text style={styles.Txt812}>Go Back To Home</Text>
        </TouchableRipple>
      </View>
    </View>
  );
